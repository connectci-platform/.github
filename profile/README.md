...
People directories · affinity groups · recurring events with registration · knowledge base · structured mentorship & matchmaking · badges and community recognition · the Appverse Open OnDemand app catalog · a RAG support chatbot with MCP servers and public content APIs · CILogon federated sign-on.

---

Built by the Connect.CI team, originally as the Northeast Cyberteam. Licensed GPL-2.0-or-later.
